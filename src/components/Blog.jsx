  ...
  return (
    <div className="bg-[#0D133E] py-9">
      ...
      <Swiper
        ...
        breakpoints={{
          320: {
            slidesPerView: 2, // عرض شريحة واحدة في الشاشات الصغيرة
          },
          568: {
            slidesPerView: 3, // عرض شريحتين في الشاشات المتوسطة
          },
          768: {
            slidesPerView: 4, // عرض شريحتين في الشاشات المتوسطة
          },
          1024: {
            slidesPerView: 5, // عرض 3 شرائح في الشاشات الكبيرة
          },
        }}
        ...
        {blogs.map((blog) => (
          <SwiperSlide key={blog.id}>
            <div className="bg-[#1D2144] rounded-lg">
              ...
              <div className="px-6 flex items-center h-auto gap-5 text-xs my-5">
                <div>
                  <img
                    src={av1}
